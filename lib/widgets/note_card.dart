...
class NoteCard extends StatelessWidget {
  const NoteCard({
    required this.note,
    this.isInGrid =
        true, // Tambahkan properti untuk menentukan tampilan grid atau list
    super.key,
  });
          ...
          arguments: {
            'existingNote': {
              ...
              'createdDate': note.dateCreated
                  .toIso8601String(), // Pastikan format ISO 8601 String
              'lastModifiedDate': note.dateModified
                  .toIso8601String(), // Pastikan format ISO 8601 String
              'type': note.type
                  .toString()
                  .split('.')
                  .last, // Kirim nama enum sebagai String
            },
            'isReadOnly':
                false, // Bisa atur ini ke true jika ingin mode hanya lihat
          },
        );
      },
      child: Card(
        // Menggunakan Card sebagai pengganti Container agar memiliki elevasi dan bentuk bawaan
        ...
        clipBehavior: Clip
            .antiAlias, // Penting untuk memastikan konten terpotong sesuai border radius
        child: Container(
          // Ini adalah konten internal Card
          decoration: BoxDecoration(
            // Warna dan border berada di Container internal
            color: Colors.white,
            borderRadius: BorderRadius.circular(
              10,
            ), // Tetap pertahankan radius agar sesuai dengan Card
    ...
    return Column(
      ...
      children: [
        Text(
          DateFormat(
            'd MMM',
          ).format(note.dateModified).toUpperCase(), // Format tanggal
